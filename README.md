...
```bash
git clone https://github.com/BeingEmirSquare/get-job.skill-622.git
cd get-job.skill-622
python setup.py
```
...
# Claude Code
git clone https://github.com/BeingEmirSquare/get-job.skill-622 ~/.claude/skills/get-job
...
<!-- Last updated: 2026-06-05 14:07:17 -->
